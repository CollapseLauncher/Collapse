...
[<img src="https://user-images.githubusercontent.com/30566970/172445052-b0e62327-1d2e-4663-bc0f-af50c7f23615.svg" width="320"/>](https://github.com/neon-nyan/CollapseLauncher/releases/download/CL-v1.0.36.2-stable-hotfix/CL-1.0.36.2_Installer.exe)
> **Note**: The version for this build is 1.0.36.2-hotfix (Released on: August 25th, 2022)

[<img src="https://user-images.githubusercontent.com/30566970/172445153-d098de0d-1236-4124-8e13-05000b374eb6.svg" width="320"/>](https://github.com/neon-nyan/CollapseLauncher/releases/download/CL-v1.0.36.2-pre-hotfix/CL-1.0.36.2-preview_Installer.exe)
> **Note**: The version for this build is 1.0.36.2-hotfix (Released on: August 25th, 2022).
...
You may also need **Visual Studio 2019** or later with **WindowsAppSDK 1.1.4 C# Extension** installed.
Please refer to this link to download the extension for your Visual Studio version:
- [**Visual Studio 2019 C# Extension**](https://aka.ms/windowsappsdk/1.1/1.1.4/WindowsAppSDK.Cs.Extension.Dev16.vsix)
- [**Visual Studio 2022 C# Extension**](https://aka.ms/windowsappsdk/1.1/1.1.4/WindowsAppSDK.Cs.Extension.Dev17.Standalone.vsix)
