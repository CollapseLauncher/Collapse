...
{
    internal sealed partial class GeneralData : IGameSettingsValue<GeneralData>
    {
        #region Fields
        ...
        public GeneralData() : this(null) {}

        private GeneralData(IGameSettings gameSettings)
        {
        ...
        #region Methods
#nullable enable
        public static GeneralData Load(IGameSettings gameSettings)
        {
            try
            {
                if (gameSettings.RegistryRoot == null)
                    throw new ArgumentNullException($"Cannot load {ValueName} since RegistryKey is unexpectedly not initialized!");
                ...
                data.ParentGameSettings = gameSettings;
                return data;
            }
            catch (Exception ex)
            {
        ...
        public void Save()
        {
            try
            {
                if (ParentGameSettings.RegistryRoot == null)
                    throw new NullReferenceException($"Cannot save {ValueName} since RegistryKey is unexpectedly not initialized!");
