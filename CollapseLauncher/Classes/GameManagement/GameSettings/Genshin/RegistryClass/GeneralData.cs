...
namespace CollapseLauncher.GameSettings.Genshin
{
    internal class GeneralData
    {
        ...
        public bool         urlCheckCached            { get; set; } = true;
...
#nullable enable
        public static GeneralData Load()
        {
            ...
            catch (Exception ex)
            {
                ...
                GeneralData data = _generalDataDefault!.Deserialize<GeneralData>(GenshinSettingsJSONContext.Default) ?? new GeneralData();
