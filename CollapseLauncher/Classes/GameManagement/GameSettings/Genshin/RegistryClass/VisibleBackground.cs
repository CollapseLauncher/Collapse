...
{
    internal class VisibleBackground : IGameSettingsValue<VisibleBackground>
    {
        #region Fields
        ...
        private VisibleBackground(IGameSettings gameSettings)
        {
        ...
        #region Methods
        #nullable enable
        public static VisibleBackground Load(IGameSettings gameSettings)
        {
            try
            {
...
#endif 
                    return new VisibleBackground(gameSettings) { borderless = borderless };
                }
            }
            catch (Exception ex)
            {
            ...
            return new VisibleBackground(gameSettings);
        }
        ...
        public void Save()
        {
            try
            {
                ...
                ParentGameSettings.RegistryRoot.SetValue(ValueName, borderless, RegistryValueKind.DWord);
#if DEBUG
