...
namespace CollapseLauncher.GameSettings.StarRail
{
    internal class VOVolume : IGameSettingsValue<VOVolume>
    {
        ...
        private VOVolume(IGameSettings gameSettings)
        {
        ...
        #region Methods
#nullable enable
        public static VOVolume Load(IGameSettings gameSettings)
        {
            try
            {
...
#endif
                    return new VOVolume(gameSettings) { VOVol = voVolume };
                }
            }
            catch (Exception ex)
            {
            ...
            return new VOVolume(gameSettings);
        }
        ...
        public void Save()
        {
            try
            {
                ...
                ParentGameSettings.RegistryRoot.SetValue(ValueName, VOVol, RegistryValueKind.DWord);
#if DEBUG
