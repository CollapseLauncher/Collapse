        ...
        internal static
            ...
            {
            {
                ...
                new WindowSizeProp
                {
                    ...
                    PostPanelBounds              = new Size(340, 100),
                    ...
                    PostPanelPaimonTextMargin    = new Thickness(0, 0,   0,   24),
            ...
            },
            {
                ...
                new WindowSizeProp
                {
                    ...
                    PostPanelBounds              = new Size(280, 80),
                    PostPanelBottomMargin        = new Thickness(0, 0, 0, 12),
                    PostPanelPaimonHeight        = 110,
                    PostPanelPaimonMargin        = new Thickness(0, -48, -56, 0),
                    PostPanelPaimonInnerMargin   = new Thickness(0, 0,   0,   0),
                    PostPanelPaimonTextMargin    = new Thickness(0, 0,   0,   20),
                    PostPanelPaimonTextSize      = 11,
                    BannerIconHeight             = 32,
