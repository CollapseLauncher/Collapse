    ...
    public sealed partial class Locale
    {
        ...
        public sealed partial class LocalizationParams
        {
            ...
            public sealed partial class LangSettingsPage
            {
                ...
                public string VideoBackground_UseFFmpeg                              { get; set; } = LangFallback?._SettingsPage.VideoBackground_UseFFmpeg;
                public string VideoBackground_FFmpegInstallStatus                    { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallStatus;
                public string VideoBackground_FFmpegInstallStatus_Installed          { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallStatus_Installed;
                public string VideoBackground_FFmpegInstallStatus_NotInstalled       { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallStatus_NotInstalled;
                public string VideoBackground_FFmpegInstallBtn_InstallationWizard    { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallBtn_InstallationWizard;
                public string VideoBackground_FFmpegInstallNote                      { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallNote;
                public string VideoBackground_FFmpegInstallNoteContent               { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallNoteContent;
                public string VideoBackground_FFmpegInstallLockedTitle               { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallLockedTitle;
                public string VideoBackground_FFmpegInstallLockedContent             { get; set; } = LangFallback?._SettingsPage.VideoBackground_FFmpegInstallLockedContent;
